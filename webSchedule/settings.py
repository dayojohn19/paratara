...
PAYMONGO_FLOW_PRINT_DELAY_SECONDS = config("PAYMONGO_FLOW_PRINT_DELAY_SECONDS", default="0.4")
...
PAYMONGO_CREATE_CUSTOMER_RESOURCE = config("PAYMONGO_CREATE_CUSTOMER_RESOURCE", default=True, cast=bool)
PAYMONGO_CUSTOMER_API_VERSION = config("PAYMONGO_CUSTOMER_API_VERSION", default="v2")
PAYMONGO_ATTACH_CUSTOMER_TO_CHECKOUT = config("PAYMONGO_ATTACH_CUSTOMER_TO_CHECKOUT", default=True, cast=bool)
PAYMONGO_CHECKOUT_CUSTOMER_ID_FALLBACK = config("PAYMONGO_CHECKOUT_CUSTOMER_ID_FALLBACK", default=True, cast=bool)
...
PAYMONGO_FLOW_PRINT_DELAY_SECONDS = config("PAYMONGO_FLOW_PRINT_DELAY_SECONDS", default=1.0, cast=float)
DJANGO_PAYMENT_BASE_URL = config("DJANGO_PAYMENT_BASE_URL", default="")
# Django email settings (SMTP)
# Temporary defaults are empty/disabled to avoid misconfiguration issues during development.
