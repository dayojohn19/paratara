...
class Collection(models.Model):
    ...
    def __str__(self):
        return f"{self.collectionPlace.placeName }  -  {self.collectionName}  -  {self.collectionUniqueID}  -     {self.collectionCollector}"
        # return f" -  {self.collectionName}  -  {self.collectionUniqueID}  -     {self.collectionCollector}"

    def forQRValues(self):
        # return f' {self.collectionName}, {self.collectionPlace} ,{self.collectionUniqueID}'
    ...
    def serialize(self):
        ...
        return {
            ...
            'collectionPicture': self.collectionPicture,
            'collectionCollector': self.collectionCollector.visitorName,
