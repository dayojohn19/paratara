...
function addMoreDates() {
  ...
  // Calendar icon
  const dateCalendarIcon = document.createElement("span");
  dateCalendarIcon.classList.add("date-icon");
  ...
  dateElement.classList.add("date-input");
  dateElement.required = true;

  // Remove button
  const dateRemoveButton = document.createElement("span");
  dateRemoveButton.classList.add("remove-date-btn");
  dateRemoveButton.innerHTML = "–";
  dateRemoveButton.onclick = () => dateContainer.remove();

  // Add button
  const dateAddButton = document.createElement("span");
  dateAddButton.classList.add("add-date-btn");
  dateAddButton.innerHTML = "+";
  dateAddButton.onclick = addMoreDates;
