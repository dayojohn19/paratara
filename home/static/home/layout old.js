...
function scrollFormDown(targetScroll) {
  ...
  // const nextSection = document.querySelector(`.${targetScroll}`)
  if (nextSection) {
...
//   console.log
//   document.querySelector('.first-section-form').style.display = 'none';
//   document.querySelector('.second-section-form').style.display = 'block';
// });

// document.getElementById('second-next').addEventListener('click', function() {
//   const invalidFields = document.querySelector("input[name='meetPlace']:invalid");
//   const invalidFields2 = document.querySelector("input[name='place']:invalid");
// if (invalidFields1.length > 0 || invalidFields2.length > 0) {
...
//   document.querySelector('.second-section-form').style.display = 'none';
//   document.querySelector('.third-section-form').style.display = 'block';
// });
// document.getElementById('third-next').addEventListener('click', function() {
//   document.querySelector('.fourth-section-form').style.display = 'none';
//   document.querySelector('.fifth-section-form').style.display = 'block';
// });
